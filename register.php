 ...
 * Description: We are creating a professional application similar to Reddit where working professionals can connect with each other.
 Register page is used to allow user to register if they have not done so already. This will add data to the user table and the profile table to be used
 by php such as the profile page, home page, messaging system and the admin page. 
-->
